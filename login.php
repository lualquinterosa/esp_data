...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $consulta = sprintf("SELECT `name`, `pwd` FROM `users` WHERE `name`='%s';",
                                    ...
                                    <form class="user" method="POST" action="">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                                id="nombre_usuario" name="nombre_usuario" aria-describedby="emailHelp" placeholder="Ingrese el usuario">
</div>
<div class="form-group">
<input type="password" class="form-control form-control-user"
                                             id="contraseña" name="contraseña" placeholder="Password">
</div>
<!--div class="form-group">
